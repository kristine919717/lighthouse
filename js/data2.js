...
;
  ...
  chartGroup2.append('g').attr('class','x-axis2').attr('transform','translate(0,470)').call(xAxis.ticks(7)).style("font", "18px san-serif");;
  chartGroup2.append('g').attr('class','y-axis2').attr('transform','translate(-20,0)').call(customYAxis).style("font", "18px san-serif");
